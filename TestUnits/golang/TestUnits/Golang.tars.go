...
func (_obj *Golang) Ping(req string, _opt ...map[string]string) (ret string, err error) {
...
func (_obj *Golang) PingWithContext(tarsCtx context.Context, req string, _opt ...map[string]string) (ret string, err error) {
...
func (_obj *Golang) PingOneWayWithContext(tarsCtx context.Context, req string, _opt ...map[string]string) (ret string, err error) {
...
func (_obj *Golang) SetServant(s m.Servant) {
	_obj.s = s
}

//TarsSetTimeout sets the timeout for the servant which is in ms.
func (_obj *Golang) TarsSetTimeout(t int) {
	_obj.s.TarsSetTimeout(t)
}

//TarsSetProtocol sets the protocol for the servant.
func (_obj *Golang) TarsSetProtocol(p m.Protocol) {
	_obj.s.TarsSetProtocol(p)
}

//AddServant adds servant  for the service.
func (_obj *Golang) AddServant(imp _impGolang, obj string) {
	tars.AddServant(_obj, imp, obj)
}

//AddServant adds servant  for the service with context.
func (_obj *Golang) AddServantWithContext(imp _impGolangWithContext, obj string) {
	tars.AddServantWithContext(_obj, imp, obj)
}

type _impGolang interface {
	Ping(req string) (ret string, err error)
}
type _impGolangWithContext interface {
...
func (_obj *Golang) Dispatch(tarsCtx context.Context, _val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, _withContext bool) (err error) {
	var length int32
	var have bool
	var ty byte
	...
	case "ping":
		...
		if _withContext == false {
			_imp := _val.(_impGolang)
			_funRet_, err = _imp.Ping(req)
		} else {
			_imp := _val.(_impGolangWithContext)
